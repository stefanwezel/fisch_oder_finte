...
if __name__ == '__main__':
    ...
    if not os.path.exists(args.real_fish_data):
        warnings.warn(f"The specified file {args.real_fish_data} does not exists... Please make sure to enter a valid filename...")
    ...
    try:
        while True:
            ...
            if key_pressed != key.ENTER:
                print("-"*50)
                print(f"Das Spiel wurde beendet. Du hast in {rounds_counter} Runde insgesamt {points} erreicht.")
